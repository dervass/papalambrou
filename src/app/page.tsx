          ...
          <div className="flex flex-col items-center md:items-end space-y-1 text-[#28322c]">
            <div className="flex flex-col md:flex-row items-center md:items-end space-y-1 md:space-y-0 md:space-x-6">
              <div className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-[#4d5f52]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
            ...
            <div className="flex items-center space-x-2">
              <svg className="w-5 h-5 text-[#4d5f52]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-row items-center gap-10 pt-4">
                  <a href="https://www.instagram.com/papalamprou_ioannis_ae/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
                  ...
                  <a href="https://www.facebook.com/p/%CE%A0%CE%B1%CF%80%CE%B1%CE%BB%CE%AC%CE%BC%CF%80%CF%81%CE%BF%CF%85-%CE%99%CF%89%CE%AC%CE%BD%CE%BD%CE%B7%CF%82-%CE%91%CE%95-61562409920251/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
            ...
            <div className="bg-[#f3dfc1] rounded-[2.5rem] p-8 md:p-12 text-[#28322c] shadow-xl relative overflow-hidden flex-1 flex flex-col border border-[#e5d0b3]">
              ...
              <div className="grid grid-cols-3 gap-4 pt-4 border-t border-[#dcc5a3] mt-auto">
                <div className="flex flex-col items-center text-center space-y-3">
                  <svg className="w-10 h-10 md:w-12 md:h-12 text-[#28322c]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                  <span className="font-bold text-sm md:text-lg uppercase tracking-tight">Αξιοπιστία</span>
                </div>
                <div className="flex flex-col items-center text-center space-y-3">
                  <svg className="w-10 h-10 md:w-12 md:h-12 text-[#28322c]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71z" /></svg>
      ...
      <footer className="bg-[#1a1a1a] text-white/40 py-6">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-8">
            ...
            >
              <svg className="w-5 h-5 text-white/40 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 15l7-7 7 7" /></svg>
            </button>
          </div>
        </div>
      </footer>
